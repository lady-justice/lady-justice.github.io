...
export const STRINGS = {
  en: {
    ...
    home_preview_weekend: 'No group classes on Sunday — see you Monday!',
    ...
    schedule_lede:
      'Mon–Sat at JUSTICE Fitness & Dance. Group classes use the My Fitness Trainer app; personal sessions and studio time use Calendly on the Book page.',
    schedule_cta: 'Open My Fitness Trainer',
    schedule_cta_title: 'My Fitness Trainer on the App Store (iOS).',
    schedule_cta_android: 'Google Play (Android)',
    schedule_week_aria: 'Group class timetable, Monday through Saturday',
  ...
  el: {
    ...
    home_preview_weekend: 'Την Κυριακή δεν υπάρχουν ομαδικά — τα λέμε τη Δευτέρα!',
    ...
    schedule_lede:
      'Δευ–Σάβ στο JUSTICE Fitness & Dance. Τα ομαδικά μέσω My Fitness Trainer· ατομικά μαθήματα και στούντιο μέσω Calendly στη σελίδα Κράτηση.',
    schedule_cta: 'Άνοιγμα My Fitness Trainer',
    schedule_cta_title: 'My Fitness Trainer στο App Store (iOS).',
    schedule_cta_android: 'Google Play (Android)',
    schedule_week_aria: 'Πρόγραμμα ομαδικών μαθημάτων, Δευτέρα έως Σάββατο',
  ...
  ru: {
    ...
    home_preview_weekend: 'В воскресенье групповых нет — до встречи в понедельник!',
    ...
    schedule_lede:
      'Пн–сб в JUSTICE Fitness & Dance. Групповые — в My Fitness Trainer; персональные занятия и студия — в Calendly на странице «Запись».',
    schedule_cta: 'Открыть My Fitness Trainer',
    schedule_cta_title: 'My Fitness Trainer в App Store (iOS).',
    schedule_cta_android: 'Google Play (Android)',
    schedule_week_aria: 'Расписание групповых занятий, понедельник–суббота',
